...
def chat_with_model(user_message, history):
    prompt = "You are an empathetic mental health chatbot trained to give mental health support and make the end user happy. Respond in a short messege in calm and supportive tone.\n"
